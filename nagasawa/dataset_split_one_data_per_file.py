...
SRC_FILE_NAME = '/home/student/docker_share/dataset/data_src/BERT_to_emotion/window_size_{0}/BERT_to_emo_{1}.txt'.format(window_size, mode)
DST_FILE_NAME_HEAD = '/media/student/f43ee0af-8eb5-4897-b97d-340c0940b9e1/{1}/split_BERT_to_emo_{1}_'.format(window_size, mode)
